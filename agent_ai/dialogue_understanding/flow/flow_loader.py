...
from agent_ai.dialogue_understanding.flow.flow import Flow, FlowsList
from agent_ai.shared.yaml_loader import read_yaml_file, read_yaml_files
from agent_ai.shared.exceptions import ConfigurationException
...
class FlowLoader:
    ...
    def load_from_string(self, yaml_string: str) -> FlowsList:
        ...
        Returns:
            FlowsList实例
        """
        from agent_ai.shared.yaml_loader import read_yaml_string
