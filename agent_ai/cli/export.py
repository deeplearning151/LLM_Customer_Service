...
def export_command(
    ...
    示例:
        agent export --output ./export/model.tar.gz
        agent export --format zip --output ./export/model.zip
        agent export --format json --output ./export/domain.json
    """
