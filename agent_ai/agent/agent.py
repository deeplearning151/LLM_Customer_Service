...
from agent_ai.agent.message_processor import (
    MessageProcessor,
    ProcessorConfig,
    MessageResponse,
)
from agent_ai.agent.actions import register_action, Action
from agent_ai.agent.graph import (
    get_message_processing_graph,
    create_initial_state,
)
from agent_ai.core.tracker import DialogueStateTracker
from agent_ai.core.domain import Domain
from agent_ai.core.stores import create_tracker_store, TrackerStore
from agent_ai.dialogue_understanding.flow import FlowsList, FlowLoader
from agent_ai.dialogue_understanding.generator import LLMCommandGenerator
from agent_ai.dialogue_understanding.processor import CommandProcessor
from agent_ai.policies import PolicyEnsemble, FlowPolicy, EnterpriseSearchPolicy
from agent_ai.shared.yaml_loader import read_yaml_file
from agent_ai.shared.config import AgentConfig, LLMConfig
...
class Agent:
    ...
    def load(
        ...
        """
        import tempfile
        from agent_ai.training.model_storage import (
        ...
        if project_path.is_file() and project_path.name.endswith(".tar.gz"):
            ...
            # 解压到临时目录
            temp_dir = tempfile.mkdtemp(prefix="agent_model_")
        ...
        from agent_ai.shared.config import EndpointsConfig
        ...
        if config_path.exists():
            ...
            if config_data:
                ...
                if "retrieval" in config_data:
                    from agent_ai.shared.config import RetrievalConfig
        ...
        if llm_config:
            from agent_ai.dialogue_understanding.generator import (
                LLMCommandGenerator,
                LLMGeneratorConfig,
            )
        ...
        # 创建策略
        from agent_ai.policies import EnterpriseSearchPolicyConfig
        ...
        if retriever_class_path:
            try:
                from agent_ai.retrieval import create_retriever
        ...
        if nlg_config and nlg_config.rephrase_enabled:
            try:
                from agent_ai.nlg import ResponseRephraser, RephraserConfig, TemplateNLG
                ...
                if rephrase_llm_config:
                    ...
                    # 创建LLM客户端
                    from agent_ai.shared.llm import create_llm_client
