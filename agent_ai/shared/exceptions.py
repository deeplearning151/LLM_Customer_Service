...
class ModelNotFound(AgentException):
    """模型未找到异常
...
class ModelLoadException(AgentException):
    """模型加载异常
...
class ModelTrainingException(AgentException):
    """模型训练异常
...
class TrackerStoreException(AgentException):
    """Tracker存储异常基类
...
class DialogueUnderstandingException(AgentException):
    """对话理解异常基类
...
class ActionException(AgentException):
    """Action异常基类
...
class ChannelException(AgentException):
    """通道异常基类
